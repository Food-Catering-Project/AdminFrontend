...
const OwnerForm = ({ setOwnerData, nextStep }) => {
  const [formData, setFormData] = useState({
    ...
    panCard: "",
    password: "",
    role: "Owner", // 🔸 Add role field here
    ...
    <div className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-lg mt-6 border-t-4 border-orange-600">
      ...
      <div className="space-y-4">
        ...
        <select
          ...
          value={formData.role}
          onChange={handleChange}
          className="border border-gray-300 p-2 w-full rounded-lg focus:ring-2 focus:ring-orange-400 outline-none bg-white"
        >
          <option value="">Select Role</option>
          <option value="Owner">Owner</option>
          {/* Future: <option value="ADMIN">Admin</option> */}
        </select>
