...
//     setMenuData([...menus]); // Ensure latest menu data is passed
//     handleSubmit([...menus]); // Pass updated data directly to handleSubmit
...
//               className="border border-gray-300 p-2 rounded-lg focus:ring-2 focus:ring-orange-400 outline-none"
//               required
//             />
//             <input
//               name="price"
